...
public class RoleDAO extends BaseHibernateDAO {
	...
	public static final String HIGHEST_PRI = "highestPri";
	...
	public Role findById(java.lang.Integer id) {
		...
		try {
			Role instance = (Role) getSession().get("com.webrender.dao.Role",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Role instance) {
		...
		try {
			List results = getSession()
					.createCriteria("com.webrender.dao.Role").add(
	...
	public List findByHighestPri(Object highestPri) {
		return findByProperty(HIGHEST_PRI, highestPri);
	}
